    ...
    static async handleLootlabsClientSide() {
        ...
        return new Promise((resolve) => {
            ...
            function createFEAROverlay() {
                ...
                a.id = "fear-console";
                a.innerHTML = '<div id="fear-console-header"><div id="fear-console-title"><div id="fear-console-title-icon">F</div><span>Console Output</span><span id="fear-console-status">ACTIVE</span></div><div id="fear-console-controls"><button class="fear-console-btn minimize" title="Minimize/Expand">─</button></div></div><div id="fear-console-body"><div id="fear-console-empty">Processing messages...</div></div><div id="fear-console-input-line"><span>FEAR://</span><span class="fear-console-cursor"></span></div>';
                o.appendChild(a);
                consoleElement = a;
                ...
                i.id = "fear-info";
                i.innerHTML = '<p id="fear-description">Server-Side captcha solving by Captcha Challenger!<br><br>Having issues? Report them in our <a href="https://trw.lat/ds" target="_blank">Discord</a></p><p id="fear-status">F.E.A.R Is bypassing Loot-links...<strong>Requests completed: <span id="fear-counter">0/6</span></strong></p>';
                o.appendChild(i);
